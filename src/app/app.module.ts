...
import { BuyListComponent } from './content/modules/buy/components/buy-list/buy-list.component';
import { CategoryListComponent } from './content/modules/category/components/category-list/category-list.component';
...
@NgModule({
  ...
  providers: [{ provide: APP_BASE_HREF, useValue: '' }, HttpClientModule],
